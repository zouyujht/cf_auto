...
[![Deploy to Cloudflare Workers](https://workers.cloudflare.com/resources/button/deploy-with-workers-dark.svg)](https://deploy.workers.cloudflare.com/?url=https://github.com/YOUR_USERNAME/YOUR_REPOSITORY)```
